  ...
  return (
    <>
      ...
      <div
        ref={cardRef}
        className={cn(
          'group glass-card interactive-spotlight sheen-on-hover p-6 space-y-5 cursor-pointer transition-all duration-500',
          'focus-visible:outline-none focus-visible:ring-0 focus-visible:[box-shadow:var(--focus-ring)]',
          post.is_pinned && 'border-primary/40 shadow-glass-lg',
          className,
        )}
      ...
      >
        ...
        <div className="space-y-3">
          {post.is_pinned && (
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-wider text-primary shadow-glass">
        ...
        <div className="flex items-center justify-between gap-4 border-t border-white/10 pt-4">
          ...
          <div className="flex flex-shrink-0 items-center space-x-2">
            <Button
              ...
              size="sm"
              onClick={handleLike}
              className="liquid-glass-button px-3 py-1 text-xs uppercase tracking-wide text-muted-foreground"
            >
              <Heart
                className={cn(
            ...
            <Button
              ...
              size="icon"
              onClick={handleShare}
              className="liquid-glass-button text-muted-foreground"
            >
