...
const (
	UploadService_RequestUploadURL_FullMethodName = "/upload.UploadService/RequestUploadURL"
)
...
func (c *uploadServiceClient) RequestUploadURL(ctx context.Context, in *RequestUploadURLRequest, opts ...grpc.CallOption) (*RequestUploadURLResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RequestUploadURLResponse)
	err := c.cc.Invoke(ctx, UploadService_RequestUploadURL_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUploadServiceServer) RequestUploadURL(context.Context, *RequestUploadURLRequest) (*RequestUploadURLResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestUploadURL not implemented")
}
...
func _UploadService_RequestUploadURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestUploadURLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UploadServiceServer).RequestUploadURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UploadService_RequestUploadURL_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UploadServiceServer).RequestUploadURL(ctx, req.(*RequestUploadURLRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _UploadService_RequestUploadURL_Handler,
		},
	},
